...
public class JNotionCredentialsRecord extends UpdatableRecordImpl<JNotionCredentialsRecord> implements Record11<UUID, UUID, String, String, String, String, String, JSONB, Boolean, LocalDateTime, LocalDateTime> {
    ...
    public Field<UUID> field1() {
        return JNotionCredentials.NOTION_CREDENTIALS.ID;
    }

    @Override
    public Field<UUID> field2() {
        return JNotionCredentials.NOTION_CREDENTIALS.USER_ID;
    }

    @Override
    public Field<String> field3() {
        return JNotionCredentials.NOTION_CREDENTIALS.API_KEY;
    }

    @Override
    public Field<String> field4() {
        return JNotionCredentials.NOTION_CREDENTIALS.DATABASE_ID;
    }

    @Override
    public Field<String> field5() {
        return JNotionCredentials.NOTION_CREDENTIALS.TITLE_PROPERTY;
    }

    @Override
    public Field<String> field6() {
        return JNotionCredentials.NOTION_CREDENTIALS.STATUS_PROPERTY;
    }

    @Override
    public Field<String> field7() {
        return JNotionCredentials.NOTION_CREDENTIALS.DATE_PROPERTY;
    }

    @Override
    public Field<JSONB> field8() {
        return JNotionCredentials.NOTION_CREDENTIALS.FILTER_CONDITIONS;
    }

    @Override
    public Field<Boolean> field9() {
        return JNotionCredentials.NOTION_CREDENTIALS.IS_ACTIVE;
    }

    @Override
    public Field<LocalDateTime> field10() {
        return JNotionCredentials.NOTION_CREDENTIALS.CREATED_AT;
    }

    @Override
    public Field<LocalDateTime> field11() {
        return JNotionCredentials.NOTION_CREDENTIALS.UPDATED_AT;
    }
    ...
    @Override
    public JNotionCredentialsRecord value1(UUID value) {
        setId(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value2(UUID value) {
        setUserId(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value3(String value) {
        setApiKey(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value4(String value) {
        setDatabaseId(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value5(String value) {
        setTitleProperty(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value6(String value) {
        setStatusProperty(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value7(String value) {
        setDateProperty(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value8(JSONB value) {
        setFilterConditions(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value9(Boolean value) {
        setIsActive(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value10(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord value11(LocalDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public JNotionCredentialsRecord values(UUID value1, UUID value2, String value3, String value4, String value5, String value6, String value7, JSONB value8, Boolean value9, LocalDateTime value10, LocalDateTime value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    /**
     * Create a detached JNotionCredentialsRecord
     */
    public JNotionCredentialsRecord() {
        super(JNotionCredentials.NOTION_CREDENTIALS);
    }

    /**
     * Create a detached, initialised JNotionCredentialsRecord
     */
    public JNotionCredentialsRecord(UUID id, UUID userId, String apiKey, String databaseId, String titleProperty, String statusProperty, String dateProperty, JSONB filterConditions, Boolean isActive, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(JNotionCredentials.NOTION_CREDENTIALS);
