...
@Data
@Schema(description = "Toggle Track認証情報作成リクエスト")
public class ToggleCredentialCreateRequestDto {
    
    @NotBlank(message = "APIキーは必須です")
    @Schema(description = "Toggle Track APIキー", example = "1234567890abcdef", required = true)
